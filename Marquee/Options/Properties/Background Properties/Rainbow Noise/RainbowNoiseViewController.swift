...
//  Marquee
//
//  Created by Mark Wong on 17/10/2022.
//

import UIKit

class RainbowNoiseViewController: UIViewController {
    ...
    private lazy var previewBox: PreviewBox = {
        let view = PreviewBox(frame: self.view.bounds, type: .rainbowNoise)
...
//        speedLabel.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -lateralPadding).isActive = true
    ...
    func initSliderValues() {
        // to do
//        let flashSpeed = LedOptions.shared.loadRainbowNoiseSpeed()
//        speedSlider.value = flashSpeed
    }
    
    @objc func flashSpeedDidChange(_ slider: UISlider) {
        LedOptions.shared.updateRainbowNoiseSpeed(slider.value)
    }
}
